...
#include "runtime/event_driven_worker.h"

#include <pybind11/pybind11.h>

namespace py = pybind11;

namespace faas::python {
    ...
    void InitModule(py::module &m) {
        ...
        clz.def(py::init([](const std::string &debug_file_path) {
            return std::make_unique<worker_lib::EventDrivenWorker>(debug_file_path);
        }));
