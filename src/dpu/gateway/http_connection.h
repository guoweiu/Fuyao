#ifndef LUMINE_HTTPCONNECTION_H
#define LUMINE_HTTPCONNECTION_H
...
namespace faas::gateway {
    ...
    private:
        ...
        void SendHttpResponse(HttpStatus status, gsl::span<const char> body = gsl::span<const char>());
