#ifndef LUMINE_FUNC_CALL_CONTEXT_H
#define LUMINE_FUNC_CALL_CONTEXT_H
...
// FuncCallContext is owned by corresponding Connection, NOT Server
    ...
    public:
        ...
        void append_input(gsl::span<const char> input) { input_.AppendData(input); }

        void append_output(gsl::span<const char> output) { output_.AppendData(output); }
        ...
        gsl::span<const char> input() const { return input_.to_span(); }

        gsl::span<const char> output() const { return output_.to_span(); }
...
#endif //LUMINE_FUNC_CALL_CONTEXT_H